...
from task_g_model import MultiModalModel
...
def main(data_path, model_stage, parameters_dict, class_weights, output_folder, checkpoints_folder, model_name):    
    ...
    # model definition
    model = MultiModalModel(device, num_classes=num_classes, replace_token=parameters_dict['replace_token']).to(device)
...
if __name__ == '__main__': 
    ...
    parameters_dict = {
        ...
        'replace_token': '' # '[MASK]' or ''
    }

    # Outputs folder
    output_folder = "c5/week6/outputs_task_g"

    # Checkpoints folder
    checkpoints_folder = "c5/week6/checkpoints"

    # Model name (used when saving plots, checkpoint, etc.)
    model_name = "multimodal_average_mask_reweighting"
